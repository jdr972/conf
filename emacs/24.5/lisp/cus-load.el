...
(put 'wp 'custom-loads '(bib-mode cus-edit delim-col ebnf2ps enriched nroff-mode outline picture printing ps-print refbib refer rng-valid rst table tildify view))
